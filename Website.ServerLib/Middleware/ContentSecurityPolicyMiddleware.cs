...
public class ContentSecurityPolicyMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context, ContentSecurityPolicyService cspService, IWebHostEnvironment env)
    {
        ...
        var csp =
            ...
            $"script-src {cspService.ScriptSrcPart} 'sha256-v8v3RKRPmN4odZ1CWM5gw80QKPCCWMcpNeOmimNL2AA=' 'unsafe-inline' 'report-sample' 'unsafe-eval' https://www.googletagmanager.com/gtag/js; " +
