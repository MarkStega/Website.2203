...
public partial class Index : ComponentBase
{
    ...
    private static readonly CarouselDataType[] CarouselData = new CarouselDataType[]
    {
        ...
        new() { Uri = "_content/Website.Lib/images/02-main-screen-search.webp", Caption = "Searching for a scheme, sorted by quantitative risk evaluation" },
        ...
        new() { Uri = "_content/Website.Lib/images/06-march-capital-flows.webp", Caption = "Chart of blended actual/forecast capital structure evolution over time" },
        new() { Uri = "_content/Website.Lib/images/07-march-land-reg.webp", Caption = "UK Land Registry sold unit prices mapped and individually detailed" },
